...
<!-- Main-------------------------------------------------------------------------------- -->
    ...
    <main class="l-main">
        <section class="p-img-top">
            <h2 class="p-title__top">ダミーサイト</h2><!-- /.p-title_header-top -->
        </section>
        
        <!-- <div class="p-container__main-aside"> -->
        <article class="p-main">
            ...
            <article class="p-map">
                <div class="p-gray-scale">
                    <div class="p-overlay__map">
                        <div class="p-container-map">
                            <h4 class="c-title__map"><span class="p-line__map">見出しが入ります</span></h4><!-- /.c-title_map -->
                            <p class="c-text__map">
                                テキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入ります
                            </p><!-- /.c-text__map -->
                        </div><!-- /.p-container-map -->
                    </div><!--.p-overlay__map -->
                </div><!-- /.gray-scale -->
